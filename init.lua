...
require('lazy').setup({
...

  {
    ...
    config = function()
      vim.api.nvim_create_autocmd('BufNewFile', {
        group = vim.api.nvim_create_augroup('sleuth-new-file', { clear = true }),
        callback = function()
          vim.cmd 'Sleuth'
        end,
      })
      ...
      -- Useful status updates for LSP.
      {
        ...
        opts = {
          progress = {
            ignore = {
              function(msg)
                return msg.lsp_client.name == 'pylsp'
              end,
            },
          },
        },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      statusline.setup { use_icons = false, sections_preset = 'minimal' }

      -- Make statusline blank
      vim.o.statusline = ''
